...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <h2 style="text-align: center">Будь ласка, редагуйте відомості про даний кримінальний акт
            </h2>
            <br>
        </div>
    </div>
...
<form:form method="post" modelAttribute="CriminalActEntity" action="/admin/act/${user.id}/edit/extrafields">
