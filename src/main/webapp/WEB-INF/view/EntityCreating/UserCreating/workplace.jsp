...
<div class="row" style="text-align: center">
    ...
    <div class="col-lg-12 col-lg-offset-5" style="text-align: center">
        <div class="input-group">
            <input type="text" class="form-control" placeholder="Сфера діяльності"/>
        </div>
        <br>
        <div class="input-group">
            <input type="text" class="form-control" placeholder="Назва організації"/>
        </div>
        <br>
        <div class="input-group">
            <input type="text" class="form-control" placeholder="Адреса організації"/>
        </div>
        <br>
        <div class="input-group">
            <input type="text" class="form-control" placeholder="Посада"/>
        </div>
        <br>
    </div>
